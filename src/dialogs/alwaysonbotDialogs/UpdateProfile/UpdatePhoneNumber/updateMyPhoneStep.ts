...
const UPDATE_PHONE_NUMBER_STEP_WATERFALL_STEP = "UPDATE_PHONE_NUMBER_STEP_WATERFALL_STEP";
...
export class UpdateMyPhoneStep extends ComponentDialog {
    constructor() {
        ...
        this.addDialog(new TextPrompt(TEXT_PROMPT))
            ...
            .addDialog(new WaterfallDialog(UPDATE_PHONE_NUMBER_STEP_WATERFALL_STEP, [
                this.checkPhoneNumberStep.bind(this),
                this.routingStep.bind(this)
            ]));

        this.initialDialogId = UPDATE_PHONE_NUMBER_STEP_WATERFALL_STEP;
    }
