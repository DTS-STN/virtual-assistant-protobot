...
export const ALWAYS_ON_BOT_WATERFALL_DIALOG = "ALWAYS_ON_BOT_WATERFALL_DIALOG";

export class AlwaysOnBotDialog extends ComponentDialog {

    constructor() {
        super(ALWAYS_ON_BOT_WATERFALL_DIALOG);
        ...
        this.addDialog(new TextPrompt("TEXT_PROMPT"))
            ...
            .addDialog(new WaterfallDialog(ALWAYS_ON_BOT_WATERFALL_DIALOG, [
